...
# en masse
# locally run
# lump_val = 3, files use the "threedayRu" naming infix
library(dplyr)
library(readr)
library(purrr)
library(tidyr)
...
posterior_suffix <- paste0("ei_cdf_threedayRu_sim",
                             sim_val, "_simnum")
...
write_csv(full_mcmc_summary, here::here("results", "my_mcmc_summaries",
                                         paste0("mcmc_diagnostics_eicdf_coal_threedayRu_sim", sim_val, "_local.csv")))
...
write_csv(my_posterior_rt, here::here("results",
                                      ...
                                      paste0("ei_cdf_threedayRu_sim", sim_val,  "_allseeds_rt_quantiles_local.csv")))
# visualize results
...
#     ggtitle(str_c("EI CoalCDF Posterior Rt Scenario ", sim_val, " Simnum ", seed_val)) +
#     my_theme
# }
# ggsave2(filename = here::here("results", paste0("ei_coalcdf_rtplots_sim", sim_val, ".pdf")),
