...
# read in the data
samp_times = CSV.read(datadir("real_data", "ebola_lbrmcc_2014_samp_timesv2.csv"), DataFrame)
coal_times_df = CSV.read(datadir("real_data", "ebola_lbrmcc_2014_coal_timesv2.csv"), DataFrame)
...
# my_states save
my_states_frame = DataFrame(my_states, :auto)
CSV.write(resultsdir("my_generated_quantities", 
string("ess_joint_hetchron_inseq_states_sim", sim, "_seed", seed, ".csv")), my_states_frame)