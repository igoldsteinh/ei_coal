...
CSV.write(datadir("compare_data", "compare_ei_state_frame_r=1.3.csv"), final_state_frame)
CSV.write(datadir("compare_data", "compare_ei_individ_frame_r=1.3.csv"), final_individ_frame)
...
# Save the results
CSV.write(datadir("compare_data", "compare_ei_impcoal_results_r=1.3.csv"), results_df5)

### time transformation, rejecting bad pop ###
final_state_frame = CSV.read(datadir("compare_data", "compare_ei_state_frame_r=1.3.csv"), DataFrame)
last_samp_time = stop_time
num_samps = 5
...
CSV.write(datadir("compare_data", "compare_ei_tt_badpop_results_r=1.3.csv"), results5_df5_ttnoneg)
...
CSV.write(datadir("compare_data", "compare_ei_ode_state_frame_r=1.3.csv"), ode_comp_frame)
...
CSV.write(datadir("compare_data", "compare_ei_tt_odebadpop_results_r=1.3.csv"), results_df5_ode)
