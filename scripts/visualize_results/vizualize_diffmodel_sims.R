# this is for visualizing the results of BDMM, PhydynR and EI Coalescent
...
control_plot <- (tree_plot_sim9 + 
                 my_plot_posterior_rt_sim9 +
                   bdmm_plot_posterior_rt_sim9 + phydyn_plot_posterior_rt_sim9) + 
  plot_annotation(title = "Simulated Tree and Posterior Ru Estimates From Three Models",
                               theme = theme(plot.title = element_text(size = 20)))
ggsave(here::here( "figures", "control50_allmodels_plot.pdf"),
       control_plot,
