"""
sample_nodescdf_andparams_skyline!()
for a fixed phylogeny, jointly sample the number of lineages in E and I at internal nodes, sample times, 
    ...
    SKYLINE NOT GMRF
    ALL RT VALUES HAVE THE DISTRIBUTION LogNORM(init_rt_mean, init_rt_sd)
...
"""
function sample_nodescdf_andparams_skyline!(q_cur::Vector{Float64}, l_cur::Float64, cholC::AbstractMatrix, log_prior_means::Vector{Float64}, 
    ...
    for i in 1:num_samples 
        ...
        q_cur, l_cur, ll_vec, lik_vec = sample_ess_simple_skyline(q_cur, l_cur, cholC, log_prior_means, num_lineages, est_times, coal_times, 
